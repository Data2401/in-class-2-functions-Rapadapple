...
````{R convert_fn}
fahrenheitToCelsiusAndFeetToMeters = function(fahrenheitTemp, feet) 
{
  celsiusTemp = (fahrenheitTemp - 32)*(5/9)
  meters = feet/3.281
  return(c(celsiusTemp, meters))
}

measurements = fahrenheitToCelsiusAndFeetToMeters(32, 24)
...
get_coffee <- function(current_cups){
  if (current_cups <= 4){
    ...
    return(get_coffee(current_cups+1))
  } else {
    return(current_cups)
  }
}
